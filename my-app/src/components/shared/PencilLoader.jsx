export default function PencilLoader({ width = "100px", height = "100px" }) {
  return (
    <div className="flex justify-center items-center p-4">
      <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 200 200" className="pencil">
        <defs>
